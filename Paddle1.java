 ...
 * @2.0
 */
public class Paddle1 extends JComponent
{
    /**VARIABLES*/
     ...
     */
    public Paddle1(int x, int y, myFrame frame)
    {
     ...
     */
     public void moveRectangleBy2(int dx, int dy)
     {
         ...
         else
         {
             if(paddle1.getY()<2)
             {
                 paddle1.setLocation(1200,0);
                 repaint();
             }
             else
             {
                 paddle1.setLocation(1200,675);
                 repaint();
             }
       }
    }
